        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentApproverId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkflowRequests_AspNetUsers_CurrentApproverId",
                        column: x => x.CurrentApproverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_WorkflowRequests_AspNetUsers_RequesterId",
                        column: x => x.RequesterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkflowRequests_ProcessDefinitions_ProcessDefinitionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WorkflowRequestId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestLogs_AspNetUsers_ProcessorId",
                        column: x => x.ProcessorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RequestLogs_WorkflowRequests_WorkflowRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestLogs_ProcessorId",
                table: "RequestLogs",
                column: "ProcessorId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestLogs_WorkflowRequestId",
                table: "RequestLogs",
                column: "WorkflowRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowRequests_CurrentApproverId",
                table: "WorkflowRequests",
                column: "CurrentApproverId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowRequests_ProcessDefinitionId",
                table: "WorkflowRequests",
                column: "ProcessDefinitionId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowRequests_RequesterId",
                table: "WorkflowRequests",
                column: "RequesterId");
        }
